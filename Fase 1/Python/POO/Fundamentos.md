...
Uma classe definir as caracteristas e comportamentos de um objetos porém não usamos ela diretamente, já o objeto é possivel user e possui as mesmas caractectistas e comportamentos descrita na classe
...
1. Herança: capacidade de definir uma classe filha para derivar/herdar da classe "pai"
    ...
    - Evita usar uma muitas camadas de reutilização
